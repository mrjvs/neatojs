...
To add line numbers to your code block, add the attribute `showLineNumbers` to your code block. If you want to make space for multiple digits, you can specify up to 3 digits like this: `showLineNumbers={3}`
...
You can add this at the end of any line of code in your code block to apply the style to the line. **Make sure to remove the slash in the examples**.
