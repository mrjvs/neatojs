...
A good usecase of when to use a different site is if you want to have different content in the navigation header.
...
That is where site templates come in: you can make a template and any site can make use a template.
...
Folder structure of your pages directory is completely flexible and up to the writers choice.
...
Think showcases, contact page, brand informations. So it's wise to put your documentation on `/docs` so you can put everything else outside of it.
2. **Put your concepts in on one level:** When you have multiple concepts like a list of libraries or a list of applications. You should all of them
...
Do not group them as `/docs/libs/xxx` or `/docs/apps/xxx`, it will only make it harder to find in your project structure and less predictable URLs.
