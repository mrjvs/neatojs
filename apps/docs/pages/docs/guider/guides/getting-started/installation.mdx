...
<Steps>
  ...
  <Steps.Step>
    ...
    const withGuider = guider({
      themeConfig: './theme.config.tsx', // location of your theme file
    });

    module.exports = withGuider({
      // these are normal Next.JS settings.
    ...
    export default defineTheme({
      ...
      directories: [
        directory({
          ...
          sidebarItems: [
            // links in your sidebar, add more below it
            link("Home", "/")
          ]
        })
      ],
  ...
  <Steps.Step>
    ...
    <Note>
      Next.JS development server is infamous for being slow. The final build of the site will be **much** faster.
    </Note>
  </Steps.Step>
</Steps>
